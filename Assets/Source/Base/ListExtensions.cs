...
namespace dEvine_and_conquer.Base
{
    public static class ListExtensions
    {
        ...
        /// <returns></returns>
        public static Chunk GetChunk(this List<Chunk> chunks, int x, int y) => chunks.GetChunk((x, y));
        ...
        /// <returns></returns>
        public static Chunk GetChunkWithPosition(this List<Chunk> chunks, int x, int y) => chunks.GetChunkWithPosition((x, y));
        ...
        public static Block GetBlockFromID(this List<Chunk> chunks, int x, int y) => chunks.GetBlockFromID((x, y));
        ...
        public static bool Contains<T>(this List<T> list, float x, float y) where T : VisualObject => list.Contains((x, y));
        ...
        public static T Get<T>(this List<T> tiles, int x, int y) where T : VisualObject => tiles.Get((x, y));

        public static T Get<T>(this List<T> tiles, Point loc) where T : VisualObject => tiles.Where(x => x.Location.Flatten() == loc).First();
        public static T Get<T>(this T[] tiles, int x, int y) where T : VisualObject => tiles.Get((x, y));
